...
export default function WhyChooseCard({ title, description, icon: Icon }: WhyChooseCardProps) {
  return (
    <div className="relative group">
      ...
      <div className="relative bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-purple-500/50 transition-colors">
        <div className="p-3 bg-gradient-to-br from-purple-500/10 to-blue-500/10 rounded-lg w-fit mb-4">
